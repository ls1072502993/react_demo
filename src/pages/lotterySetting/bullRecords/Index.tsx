...
import * as LotteryApi from '@/api/lottery/bullRecords'
...
export default function App() {
  ...
  async function getTableList() {
    ...
    // 获取统计数据
    const { data: statisticsData } = (await LotteryCommonApi.statisticsData({ ...formData, type: 4 })) as any
  ...
  useEffect(() => {
    LotteryCommonApi.getBatchList({ type: 4 }).then((res: any) => {
      setTabs([
        {
          key: '',
          label: '全部',
