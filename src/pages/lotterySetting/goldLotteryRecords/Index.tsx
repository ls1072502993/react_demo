...
import * as LotteryApi from '@/api/lottery/goldLotteryRecords'
...
export default function App() {
  ...
  async function getTableList() {
    ...
    // 获取统计数据
    const { data: statisticsData } = (await LotteryCommonApi.statisticsData({ ...formData, type: 2 })) as any
  ...
  useEffect(() => {
    LotteryCommonApi.getBatchList({ type: 3 }).then((res: any) => {
      setTabs([
        {
          key: '',
          label: '全部',
